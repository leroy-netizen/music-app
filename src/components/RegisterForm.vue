<template>
  <!-- Reagistration form starts from here -->
...
export default {
  ...
  methods: {
    async register(values) {
      ...
      this.reg_alert_message = 'Please wait while your account is being created';
      ...
      this.reg_alert_message = 'account successfuly created';
    },
  },
};
</script>
